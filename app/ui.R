    ...
    tabItems(
      ...
      tabItem(tabName = "kelompok",
              ...
              tags$ul(
                ...
                tags$li(img(src="https://user-images.githubusercontent.com/111561203/227850560-4046c2ae-76ea-49e9-847d-7ce7a3113407.png", width = 100), "Shiny Developer (Frontend) : Dini Ramadhani G1501220131"),
                tags$li(img(src="https://user-images.githubusercontent.com/111561203/227850602-2c7eb4c0-0eea-4fe5-80e3-c9793cc7d3b4.png", width = 100), "Technical Writer : Adeline Vinda Septiani G1501221006"),
              ),
